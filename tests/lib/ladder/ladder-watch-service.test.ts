...
function ladder(rungs: LadderRung[]): LadderWithRungs {
  return { id: 'L1', title: 'T', thesis: null, author: 'operator', mode: 'paper', status: 'armed', preconditionHash: 'h', ocoGroupId: null, leaderAddress: null, maxTotalNotionalUsd: null, maxTotalLossUsd: null, expiresAt: null, activeFrom: null, armedAt: null, disarmedAt: null, disarmReason: null, archivedAt: null, expiryAlertAt: null, createdAt: '', updatedAt: '', rungs };
}
