...
function ladder(rungs: LadderRung[]): LadderWithRungs {
  return { id: 'L1', title: 'T', thesis: null, author: 'operator', mode: 'paper', status: 'armed', preconditionHash: 'h', ocoGroupId: null, maxTotalNotionalUsd: null, maxTotalLossUsd: null, expiresAt: null, armedAt: null, disarmedAt: null, disarmReason: null, archivedAt: null, createdAt: '', updatedAt: '', rungs };
}
