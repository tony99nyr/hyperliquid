...
function draftLadder(over: Partial<LadderWithRungs> = {}): LadderWithRungs {
  return {
    ...
    preconditionHash: null, maxTotalNotionalUsd: 100_000, maxTotalLossUsd: 5_000,
    expiresAt: new Date(Date.now() + 3_600_000).toISOString(), armedAt: null, disarmedAt: null, disarmReason: null,
